https://huggingface.co/spaces/Qwen/Qwen-Image/blob/main/app.py
...
pipe = QwenImagePipeline.from_pretrained("/data1/jiangyy/A800/qwenimage", torch_dtype=dtype).to(device_map="auto")

# pipe = nn.DataParallel(pipe, device_ids=[0, 1])  
...
def infer(
    ...
    # Set up the generator for reproducibilitydevice = 
