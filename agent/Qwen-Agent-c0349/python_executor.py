# https://github.com/QwenLM/Qwen-Agent/blob/c0349d064a1924866788ab9aa04a4e4ecea8d041/qwen_agent/tools/python_executor.py
...
class PythonExecutor(BaseTool):
    ...
    def batch_apply(self, batch_code: List[str]) -> list:
        ...
        # all_code_snippets[0][1] = all_code_snippets[0][1].replace(" ","")
        # print(all_code_snippets[0])

        # all_code_snippets='print("Hello world!")'
        # print(all_code_snippets)
...
def _test():
    # batch_code = ["""pip list"""]
    # batch_code = ["""import torch;print(torch.__version__);print(torch.cuda.get_device_name(0));print(123321)"""]
    batch_code = ["""
        print("Hello world!")
        """]
